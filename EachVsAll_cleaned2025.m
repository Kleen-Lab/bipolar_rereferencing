...
% BIPOLAR PAIR ANALYSIS: EACH VS. ALL to make data for later plotting 
% of each vs. all figures

pts = {'EC133', 'EC175', 'EC181', 'EC183', 'EC186', 'EC187', 'EC196', ...
    'EC219', 'EC220', 'EC221', 'EC222', 'EC131', 'EC143', 'EC157', 'EC162', 'EC168'};

for p = 1:length(pts)
    EachVsAll_cleaned2025_fxn(pts{p});
end

function [mDiff, mb_m, mARb_m, Mbp_distance] = EachVsAll_cleaned2025_fxn(pt)
...
g1s2d3=2; % use either grids (1) or strips (2) or depths (3) but not the others
doanglerange=0;
recordings = [];
none1sqrt2log3=2;
%addpath(genpath('/Volumes/Maxone/bipolar_project/'));
...
save(['/Volumes/SPIKE/bipolar_project/bipolar_SeaHorse/devkrish/OMNIRERUN/fix_strips_tent_' pt '.mat'], 'mDiff', 'mb_m', 'mARb_m');
save(['/Volumes/SPIKE/bipolar_project/bipolar_SeaHorse/devkrish/OMNIRERUN/fix_strips_dist_tent_' pt '.mat'], 'distance');
...
addpath(genpath('/Volumes/Maxone/matlab_utilities-main'));
...
if g1s2d3 == 1
    ...
    pts_grids = {'EC133','EC175','EC183','EC186','EC187','EC196','EC219','EC221','EC222'};
    load('/Volumes/Maxone/bipolar_project/grids_May31_2025/m_EachVsAll_grids.mat');
    
    pos_ECs = {
        'EC133', [0.41, 0.8011, 0.17, 0.1522],
        'EC175', [0.6095, 0.8011, 0.17, 0.1522], 
        'EC183', [0.809, 0.8011, 0.17, 0.1522], 
        'EC186', [0.41, 0.6121, 0.17, 0.1522], 
        'EC187', [0.6095, 0.6121, 0.17, 0.1522], 
        'EC196', [0.809, 0.6121, 0.17, 0.1522],
        'EC219', [0.41, 0.4231, 0.17, 0.1522], 
        'EC221', [0.41, 0.2342, 0.17, 0.1522], 
        'EC222', [0.41, 0.0447, 0.17, 0.1522]};
    ...
    for i=1:9
        ...
        clim(cax); shading flat; set(gca,'yscale','log','ytick',ft,'yticklabel',ftl); 
        xlim(xldist); ylim(yldist) %colorbar;
    end
...
elseif g1s2d3 == 2
    ...
    pts_strips = {'EC133','EC175','EC183','EC186','EC187','EC196','EC219','EC221','EC222'};
    load('/Volumes/Maxone/bipolar_project/strips_June2_2025/m_EachVsAll_strips.mat');
    ...
    binz_re = 0:4:84;
    pts_depths = {'EC133','EC175','EC181','EC186','EC187','EC219','EC220','EC221','EC222'};
    load('/Volumes/Maxone/depths_June2_2025/m_EachVsAll_depths.mat')
    mDiff_re = mDiff_re([1 2 3 5 6 8 9 10 11], :, :);
...
% all plot
    ...
    clim(cax); shading flat; set(gca,'yscale','log','ytick',ft,'yticklabel',ftl); colorbar; xlim([4 20]); ylim(yldist);
    ylabel('Frequency (Hz)'); xlabel('Distance (mm)'); 
    set(gca,'fontsize',9);
